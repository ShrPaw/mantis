...
from app.event_engine.dedup import EventDeduplicator
from app.event_engine.event_logger import EventLogger
from app.event_engine.outcome_tracker import OutcomeTracker
from app.event_engine.models import MicrostructureEvent
from app.event_engine.detectors import ALL_DETECTORS
from app.event_engine.blacklist_watchlist import BlacklistWatchlistManager
...
class EventManager:
    ...
    def __init__(self, config: EventEngineConfig | None = None):
        ...
        if self.spe_enabled:
            try:
                from app.event_engine.spe import SPEOrchestrator
        ...
        try:
            from app.event_engine.spe.l3_live_calibrator import L3LiveCalibrator
